...
public class AthleteDTO {
    ...
    public AthleteDTO(String continent, String country, double height, double weight, double BMI, double age, String gender, String sport) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AthleteDTO)) return false;
