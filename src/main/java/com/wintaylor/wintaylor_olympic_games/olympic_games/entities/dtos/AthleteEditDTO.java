...
public class AthleteEditDTO {
    ...
    public AthleteEditDTO() {
    }

    public AthleteEditDTO(String continent, String country, double height, double weight, double BMI, double age, String gender, String sport) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AthleteEditDTO)) return false;
        AthleteEditDTO that = (AthleteEditDTO) o;
